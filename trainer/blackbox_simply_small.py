...
def main(argv):
    ...
    iq_dataset, iq_count = utils.MimickDataset(
        ...
        domain='iq',
        csv='./data/training-v2-verasonics-phantom.csv', 
        batch_size=args.bs)
    ...
    dtce_dataset, dtce_count = utils.MimickDataset(
        ...
        domain='dtce',
        csv='./data/training-v2-clinical-phantom.csv', 
        batch_size=args.bs)
    ...
    model.fit(iq_dataset, dtce_dataset,
              ...
              validation_steps=10,#int(val_count/args.bs),
